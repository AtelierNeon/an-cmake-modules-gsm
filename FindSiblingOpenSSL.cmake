...
if (EXISTS "${PROJECT_SOURCE_DIR}/../openssl-1_1_1/include/" AND BUILD_WITH_OPENSSL_1_1_1_PREFERRED)
  set (_OPENSSL_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/../openssl-1_1_1/include/")
...
elseif (EXISTS "${PROJECT_SOURCE_DIR}/../openssl-3_0/include/" AND BUILD_WITH_OPENSSL_3_0_PREFERRED)
  set (_OPENSSL_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/../openssl-3_0/include/")
  set (_OPENSSL_INCLUDE_DIRS
    "${_OPENSSL_INCLUDE_DIR}"
  ...
  if (EXISTS "${PROJECT_SOURCE_DIR}/../openssl/include/")
    set (_OPENSSL_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/../openssl/include/")
    set (_OPENSSL_INCLUDE_DIRS
      "${_OPENSSL_INCLUDE_DIR}"
  ...
  elseif (EXISTS "${PROJECT_SOURCE_DIR}/../openssl-3_0/include/")
    ...
    set (_OPENSSL_INCLUDE_DIRS
      ...
      "${PROJECT_BINARY_DIR}/../openssl-3_0/include/")
    set (_OPENSSL_3_0_FOUND TRUE)
  elseif (EXISTS "${PROJECT_SOURCE_DIR}/../../openssl/include/")
    set (_OPENSSL_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/../../openssl/include/")
    set (_OPENSSL_INCLUDE_DIRS
      "${_OPENSSL_INCLUDE_DIR}"
      "${PROJECT_BINARY_DIR}/../../openssl/include/")
...
if (_OPENSSL_1_1_1_FOUND)
  ...
  set (OPENSSL_INCLUDE_DIRS ${_OPENSSL_INCLUDE_DIRS})
...
elseif (_OPENSSL_FOUND)
  ...
  set (OPENSSL_LIBRARIES
    ${OPENSSL_CRYPTO_LIBRARY}
    ${OPENSSL_SSL_LIBRARY})
  if (EXISTS "${_OPENSSL_INCLUDE_DIR}/openssl/opensslv.h")
    file (READ "${_OPENSSL_INCLUDE_DIR}/openssl/opensslv.h" _OPENSSL_VERSION)
    string (FIND "${_OPENSSL_VERSION}" "OpenSSL 1.1.1" match_1_1_1)
    if (${match_1_1_1} GREATER_EQUAL 0)
      message (STATUS "Sibling OpenSSL 1.1.1 found.")
      set (OPENSSL_1_1_1_FOUND TRUE)
    endif ()
  endif ()
  if (EXISTS "${_OPENSSL_INCLUDE_DIR}/../VERSION.dat")
    file (READ "${_OPENSSL_INCLUDE_DIR}/../VERSION.dat" _OPENSSL_VERSION)
    string (FIND "${_OPENSSL_VERSION}" "MAJOR=3" match_major3)
    string (FIND "${_OPENSSL_VERSION}" "MINOR=0" match_minor0)
    string (FIND "${_OPENSSL_VERSION}" "MINOR=5" match_minor5)
    if (${match_major3} GREATER_EQUAL 0)
      if (${match_minor0} GREATER_EQUAL 0)
        message (STATUS "Sibling OpenSSL 3.0 found.")
        set (OPENSSL_3_0_FOUND TRUE)
      elseif (${match_minor5} GREATER_EQUAL 0)
        message (STATUS "Sibling OpenSSL 3.5 found.")
        set (OPENSSL_3_5_FOUND TRUE)
      endif ()
    endif ()
  endif ()
else ()
...
if (OPENSSL_1_1_1_FOUND)
  set (OPENSSL_VERSION "1.1.1")
endif ()
if (OPENSSL_3_0_FOUND)
  set (OPENSSL_VERSION "3.0")
endif ()
if (OPENSSL_3_5_FOUND)
  set (OPENSSL_VERSION "3.5")
endif ()
...
unset (_OPENSSL_3_5_FOUND)
unset (_OPENSSL_FOUND)
unset (_OPENSSL_INCLUDE_DIRS)
unset (_OPENSSL_INCLUDE_DIR)
